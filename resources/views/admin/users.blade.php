                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-2">
                                <a href="#detailRow{{ $user->id }}" class="btn-action text-primary" data-bs-toggle="collapse" title="Lihat Detail">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <button class="btn-action text-danger" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $user->id }}" title="Hapus">
