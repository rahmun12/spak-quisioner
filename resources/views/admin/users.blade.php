        ...
        <div class="mb-2 p-2">
            <form action="{{ route('admin.users') }}" method="GET" class="row g-2 align-items-end">
                <div class="col-md-3">
                    ...
                    <input type="date" class="form-control form-control-sm shadow-sm border-primary" id="date"
                        name="date" value="{{ $date ?? '' }}">
                </div>
                <div class="col-md-3">
                    <label for="service_type" class="form-label">Jenis Layanan</label>
                    <select class="form-select form-select-sm shadow-sm border-primary" id="service_type"
                        name="service_type">
                        <option value="" disabled {{ request('service_type') == '' ? 'selected' : '' }}>Semua Layanan
                        </option>
                        <option value="PBB" {{ request('service_type') == 'PBB' ? 'selected' : '' }}>PBB (Pajak Bumi dan
                            Bangunan)</option>
                        <option value="Pajak Hotel" {{ request('service_type') == 'Pajak Hotel' ? 'selected' : '' }}>Pajak
                            Hotel</option>
                        <option value="Pajak Parkir" {{ request('service_type') == 'Pajak Parkir' ? 'selected' : '' }}>Pajak
                            Parkir</option>
                        <option value="Pajak Restoran" {{ request('service_type') == 'Pajak Restoran' ? 'selected' : '' }}>
                            Pajak Restoran</option>
                    </select>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="#detailRow{{ $user->id }}" class="btn-action text-primary"
                                                ...
                                                <tbody>
                                                    @php
                                                        ...
                                                        foreach ($user->questionnaireAnswers as $answer) {
                                                            if ($answer->question) {
                                                                $answersByQuestionId[$answer->question->id] =
